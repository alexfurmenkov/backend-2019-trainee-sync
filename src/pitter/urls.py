...
from api_client.views import registration_view, login_view, logout_view, profile_view, make_delete_pitt_view, \
    save_pitt_view, follow_view, getusers_view, finduser_view, feed_view, follow_node_view, delete_node_view
...
urlpatterns = [  # pylint: disable=invalid-name
    ...
    path('follownode/', follow_node_view.Node.as_view(), name='follownode'),
    path('deletenode/', delete_node_view.DeleteNode.as_view(), name='deletenode'),
]
