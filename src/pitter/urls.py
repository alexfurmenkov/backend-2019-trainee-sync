...
from api_client.views import registration_view, login_view, make_pitt_view, save_pitt_view, follow_view, \
    getusers_view, finduser_view
...
urlpatterns = [  # pylint: disable=invalid-name
    ...
    path('makepitt/', make_pitt_view.MakePitt.as_view(), name='pitt'),
